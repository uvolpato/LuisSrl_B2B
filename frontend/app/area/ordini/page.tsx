        ...
        <div className="container">
          ...
          <div className="ordini-toolbar">
            ...
            <div className="ordini-filters">
              <div style={{ display: "flex", alignItems: "center", gap: 4, padding: "6px 8px 6px 10px", background: "var(--surface)", border: "1px solid var(--border)", borderRadius: 10, cursor: "pointer", height: 36, boxSizing: "border-box" }}
