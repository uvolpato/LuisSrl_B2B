        ...
        <div className="container">
          ...
          <div className="ordini-toolbar">
            <div className="ordini-search">
              <div style={{ position: "relative", display: "flex", flex: 1 }}>
                <input
                  ...
                  style={{ flex: 1, paddingTop: 6, paddingBottom: 6, paddingRight: search ? 34 : undefined }}
            ...
            <div className="ordini-filters">
              <div style={{ display: "flex", alignItems: "center", gap: 4, padding: "6px 14px", background: "var(--surface)", border: "1px solid var(--border)", borderRadius: 10, cursor: "pointer" }}
