...
const NAZIONI_OPTS: ComboboxOption[] = [
  ...
  { value: "FR", label: "Francia", group: "Europa" }, { value: "DE", label: "Germania", group: "Europa" },
  { value: "ES", label: "Spagna", group: "Europa" }, { value: "GB", label: "Regno Unito", group: "Europa" },
  { value: "CH", label: "Svizzera", group: "Europa" }, { value: "AT", label: "Austria", group: "Europa" },
  { value: "BE", label: "Belgio", group: "Europa" }, { value: "NL", label: "Paesi Bassi", group: "Europa" },
  { value: "PT", label: "Portogallo", group: "Europa" }, { value: "GR", label: "Grecia", group: "Europa" },
  { value: "PL", label: "Polonia", group: "Europa" }, { value: "RO", label: "Romania", group: "Europa" },
  { value: "SE", label: "Svezia", group: "Europa" }, { value: "DK", label: "Danimarca", group: "Europa" },
  { value: "FI", label: "Finlandia", group: "Europa" }, { value: "NO", label: "Norvegia", group: "Europa" },
  { value: "IE", label: "Irlanda", group: "Europa" }, { value: "CZ", label: "Rep. Ceca", group: "Europa" },
  { value: "HU", label: "Ungheria", group: "Europa" }, { value: "HR", label: "Croazia", group: "Europa" },
  { value: "SI", label: "Slovenia", group: "Europa" }, { value: "SK", label: "Slovacchia", group: "Europa" },
  { value: "BG", label: "Bulgaria", group: "Europa" }, { value: "LT", label: "Lituania", group: "Europa" },
  { value: "LV", label: "Lettonia", group: "Europa" }, { value: "EE", label: "Estonia", group: "Europa" },
  { value: "MT", label: "Malta", group: "Europa" }, { value: "CY", label: "Cipro", group: "Europa" },
  { value: "LU", label: "Lussemburgo", group: "Europa" }, { value: "IS", label: "Islanda", group: "Europa" },
  { value: "US", label: "Stati Uniti", group: "America" }, { value: "CA", label: "Canada", group: "America" },
  { value: "BR", label: "Brasile", group: "America" }, { value: "MX", label: "Messico", group: "America" },
  { value: "AR", label: "Argentina", group: "America" }, { value: "CL", label: "Cile", group: "America" },
  { value: "CO", label: "Colombia", group: "America" }, { value: "PE", label: "Perù", group: "America" },
  { value: "JP", label: "Giappone", group: "Asia" }, { value: "CN", label: "Cina", group: "Asia" },
  { value: "KR", label: "Corea del Sud", group: "Asia" }, { value: "IN", label: "India", group: "Asia" },
  { value: "AE", label: "Emirati Arabi", group: "Asia" }, { value: "SG", label: "Singapore", group: "Asia" },
  { value: "AU", label: "Australia", group: "Oceania" }, { value: "NZ", label: "Nuova Zelanda", group: "Oceania" },
  { value: "ZA", label: "Sud Africa", group: "Africa" }, { value: "EG", label: "Egitto", group: "Africa" },
  { value: "MA", label: "Marocco", group: "Africa" }, { value: "TN", label: "Tunisia", group: "Africa" },
...
export default function CheckoutPage() {
  ...
  async function applyCoupon() {
    ...
    try {
      ...
      if (res.valid) {
        if (res.type === "free-ship" && (spedizioneFee === 0 || isRitiro)) {
          ...
          <aside className="order-summary checkout-summary">
            ...
            <table className="total-table">
              <tbody>
                ...
                <tr className="bold"><td>Spedizione</td><td style={spedizioneFee === 0 || isRitiro ? { color: "oklch(55% 0.15 145)", fontWeight: 700 } : undefined}>{isRitiro || spedizioneFee === 0 ? "Gratuita" : spedizione?.descrizione === "Tariffa da confermare" ? "Da confermare" : fmtEur(spedizione?.importo ?? 0)}</td></tr>
            ...
            <div className="recap-section">
              ...
              <table className="total-table">
                <tbody>
                  ...
                  <tr><td colSpan={2}><hr className="total-divider" /></td></tr>
                  <tr className="bold"><td>Subtotale scontato</td><td>{fmtEur(subScontato)}</td></tr>
                  <tr className="bold"><td>Spedizione</td><td style={spedizioneFee === 0 || isRitiro ? { color: "oklch(55% 0.15 145)", fontWeight: 700 } : undefined}>{isRitiro || spedizioneFee === 0 ? "Gratuita" : fmtEur(spedizioneFee)}</td></tr>
                  <tr><td colSpan={2}><hr className="total-divider" /></td></tr>
                  <tr className="final"><td>Totale (IVA esclusa)</td><td>{fmtEur(totale)}</td></tr>
                </tbody>
              </table>
