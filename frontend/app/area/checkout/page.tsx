          ...
          <aside className="order-summary checkout-summary">
            ...
            <table className="total-table">
              <tbody>
                ...
                <tr className="bold"><td style={{ border: 0, borderBottom: "1px solid var(--border)" }}>Subtotale scontato</td><td style={{ border: 0, borderBottom: "1px solid var(--border)" }}>{fmtEur(subScontato)}</td></tr>
