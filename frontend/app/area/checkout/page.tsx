...
const NAZIONI_OPTS: ComboboxOption[] = [
  ...
  { value: "ES", label: "Spagna", group: "Europa" }, { value: "AT", label: "Austria", group: "Europa" },
  { value: "BE", label: "Belgio", group: "Europa" }, { value: "CH", label: "Svizzera", group: "Europa" },
  { value: "NL", label: "Paesi Bassi", group: "Europa" }, { value: "GB", label: "Regno Unito", group: "Europa" },
