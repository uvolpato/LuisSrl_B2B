...
const ALL_PERMISSIONS = [
  ...
  { key: "catalog.listini.view", label: "Visualizzare listini" },
  { key: "catalog.box-dashboard.view", label: "Visualizzare box dashboard" },
  { key: "vendite.clienti.view", label: "Visualizzare clienti" },
  { key: "vendite.clienti.edit", label: "Modificare clienti" },
  { key: "vendite.ordini.view", label: "Visualizzare ordini" },
  { key: "vendite.ordini.edit", label: "Modificare ordini" },
  { key: "vendite.spedizioni.view", label: "Visualizzare spese spedizione" },
  { key: "vendite.spedizioni.edit", label: "Modificare spese spedizione" },
