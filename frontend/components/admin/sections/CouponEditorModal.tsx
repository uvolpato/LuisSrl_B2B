          ...
          <div className="modal-root-body" style={{ padding: "24px 28px", display: "flex", flexDirection: "column", overflow: "visible" }}>
            ...
            {isEdit ? (
              ...
              <div style={{ position: "relative", flexShrink: 0, marginBottom: 8 }}>
                ...
                <input type="text" value={targetSearch} onChange={e => setTargetSearch(e.target.value)} placeholder="Cerca per codice o ragione sociale..." style={{ width: "100%", padding: "8px 10px 8px 32px", border: "1px solid var(--border)", borderRadius: 8, background: "var(--surface)", font: "inherit", fontSize: 13, color: "var(--fg)", outline: "none", boxSizing: "border-box" }} />
              </div>
              <DataTable
                columns={[
