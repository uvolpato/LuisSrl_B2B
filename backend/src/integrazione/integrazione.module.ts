...
import { CatalogoPublicController } from './catalogo-public.controller';
...
@Module({
  ...
  controllers: [IntegrazioneController, CatalogoController, CatalogoPublicController, FamiglieController],
